    ...
    class Agent : Person
    {
        ...
        public static List<Agent> getAllByCommission()
        {
            ...
            try
            {
                ...
                {
                    Agent a = new Agent();
                    a.Id = int.Parse(result["agentId"].ToString());
                    a.FirstName = result["firstName"].ToString();
                    a.LastName = result["lastName"].ToString();
                    a.Email = result["email"].ToString();
                    a.UserName = result["username"].ToString();
                    a.HomephoneNumber = result["Home"].ToString();
                    a.MobilephoneNumber = result["Mobile"].ToString();
                    a.TotalCommission = double.Parse(result["Total Commissions"].ToString());
                    a.CommissionPercent = double.Parse(result["Commission percent"].ToString());
                    agents.Add(a);
